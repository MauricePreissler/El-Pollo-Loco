...
let EndbossStart = new Audio("audio/EndbossStart.mp3");
let EndbossAttack = new Audio("audio/EndbossAttack.mp3");
...
function startGame() {
  setTimeout(() => {
    ...
    document.getElementById("gameInfoConstant").style.display = "block"; // Show controls info
    world = new World(canvas, keyboard);
  }, 500);
}

function backToStart() {
  // Clear all game intervals and reset the game state
  clearAllIntervals();

  console.log("backToStart function called");

  document.getElementById("gameInfoConstant").style.display = "none";

  // Hide any end or win screens
  document.getElementById("end-screen").style.display = "none";
  document.getElementById("win-screen").style.display = "none";

  // Show the start screen again
  document.getElementById("start-screen").style.display = "flex"; // Use 'block' or 'flex'

  // Optionally, reset any game variables or states here
  world = null; // Assuming 'world' is the game instance and you want to reset it
}

function gameInfo() {
  document.getElementById("game-info-popup").style.display = "block";
}
